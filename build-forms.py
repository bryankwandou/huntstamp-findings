...
FILES = ["TYPEFORM-ANSWERS.md", "NEW-TYPEFORM-ANSWERS.md", "NEW-TYPEFORM-ANSWERS-2.md", "NEW-TYPEFORM-ANSWERS-3.md", "NEW-TYPEFORM-ANSWERS-4.md", "NEW-TYPEFORM-ANSWERS-5.md", "NEW-TYPEFORM-ANSWERS-6.md"]
...
BATCH = [
    ...
    (43, 43, "Desktop PC / Windows 11 build 26200 / Node.js https client against the public events API / no wallet connected (logged-out guest session)",
             "September 5, 2026, 03:00-03:30, UTC"),
    (44, 99, "Desktop PC / Windows 11 build 26200 / headless Chromium via Playwright against the live site and public API / no wallet connected (logged-out guest session)",
